package com.innstack.walnut.fastdfs.client;


import com.innstack.walnut.common.exception.GlobalErrorCode;
import com.innstack.walnut.common.util.ExceptionUtils;
...
public class FastDFSClient {
    ...
    public void deleteFile(String fileUrl) {
        ...
        try {
            ...
            logger.info("FastDFSClient.deleteFile storePath group:{}, path:{}", storePath.getGroup(), storePath.getPath());
