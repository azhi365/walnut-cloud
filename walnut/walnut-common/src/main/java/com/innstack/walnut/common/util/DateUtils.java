...
import com.innstack.walnut.common.enums.DateInterval;
    ...
    public static String getDateTimeView(DateInterval dateInterval, Long millis) {
        ...
        switch (dateInterval) {
            ...
            case WEEK:
                ...
                result = String.format("%s年%s月第%s周", dateTime.getWeekyear(), dateTime.getMonthOfYear(), calendar.get(Calendar.DAY_OF_WEEK_IN_MONTH));
                break;
            case MONTH:
