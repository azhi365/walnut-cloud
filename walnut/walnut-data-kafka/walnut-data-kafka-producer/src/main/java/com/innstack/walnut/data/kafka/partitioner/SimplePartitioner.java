package com.innstack.walnut.data.kafka.partitioner;
...
public class SimplePartitioner implements Partitioner {
    ...
    public int partition(String topic, Object key, byte[] keyBytes, Object value, byte[] valueBytes, Cluster cluster) {
        ...
        logger.info("SimplePartitioner.partition topic:{}, key:{}, increment:{}, partition:{}", topic, String.valueOf(key), tempKey, partition);
