package com.innstack.walnut.redis.redis;


import com.innstack.walnut.redis.listener.RedisMessageListener;
...
//    @Bean
    ...
    RedisMessageListenerContainer keyExpirationListenerContainer(RedisConnectionFactory connectionFactory) {
        ...
        listenerContainer.addMessageListener(messageListener(), new PatternTopic("walnut.*__:expired"));
